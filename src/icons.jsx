// Iconos line-style minimalistas (lucide-inspired)
const Icon = ({ name, size = 16, ...props }) => {
  const paths = {
    ...
    sparkles: <><path d="M12 3l2.09 5.91L20 11l-5.91 2.09L12 19l-2.09-5.91L4 11l5.91-2.09L12 3z"/></>,
  ...
  return (
    <svg className="ico" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
      {paths[name] || null}
    </svg>
  );
};
